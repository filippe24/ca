...
void MainWindow::on_enable_spring_radio_clicked(bool checked)
{
    ui->openGLWidget->update_spring_bool(checked);
    ui->tabWidget_2->setTabEnabled(1, checked);
    ui->tabWidget_2->setTabEnabled(0, not(checked));
    ui->max_num->setEnabled(not(checked));
    ui->per_frame_num->setEnabled(not(checked));
    ui->actual_num->setEnabled(not(checked));
}
...
void MainWindow::on_ke_spin_2_valueChanged(double arg1)
{
    ui->openGLWidget->set_elast_ke(arg1);
}
void MainWindow::on_kd_spin_2_valueChanged(double arg1)
{
    ui->openGLWidget->set_damp_kd(arg1);
}

void MainWindow::on_l0_spin_2_valueChanged(double arg1)
{
    ui->openGLWidget->set_elast_l0(arg1);
}

void MainWindow::on_len_spring_2_valueChanged(int arg1)
{
