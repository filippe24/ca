...
private slots:
    ...
    void on_enable_spring_radio_clicked(bool checked);
    ...
    void on_ke_spin_2_valueChanged(double arg1);

    void on_kd_spin_2_valueChanged(double arg1);

    void on_l0_spin_2_valueChanged(double arg1);

    void on_len_spring_2_valueChanged(int arg1);
